    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown droping"><a><span>Категории услуг</span> <i class="bi bi-chevron-down"></i></a>
              <ul class="list-group">
          ...
          <li><a href="pricing.html">Уведомления</a></li>
          <li><a href="https://24navo.com/3/aleksei/index.php">Связаться с нами</a></li>
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <a href="#hero-carousel-indicators" class="btn-get-started scrollto">Создать заказ</a>
            </div>
          </div>
        </div>
